...
public class CancIntFeeReqBean {
	...
	private List<CancIntFeeDetailReqBean> invcsList;
    ...
    public List<CancIntFeeDetailReqBean> getInvcsList() {
    	return invcsList;
    }

	
    public void setInvcsList(List<CancIntFeeDetailReqBean> invcsList) {
