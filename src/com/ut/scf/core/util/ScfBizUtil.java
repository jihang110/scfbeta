...
public class ScfBizUtil {
	...
	public static void overwriteNullValue(final Object object, final String fieldName, final Object value) {
		Field fld = ReflectUtils.getDeclaredField(object, fieldName);
		if (fld != null && ReflectUtils.getFieldValue(object, fld) == null) {
			ReflectUtils.setFieldValue(object, fld, value);
		}
	}
}
