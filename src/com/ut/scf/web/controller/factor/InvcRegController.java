...
public class InvcRegController extends BaseBpmController<InvcRegReqBean> {
	...
	public @ResponseBody BaseRespBean getCounterPartyList(@RequestBody CounterPartyReqBean reqBean, HttpSession httpSession) {
		DataListRespBean respBean = new DataListRespBean();
		Map<String, Object> paramMap = BeanUtil.beanToMap(reqBean);
		paramMap.put("custId", httpSession.getAttribute(ScfConsts.SESSION_CORP_ID));
		respBean.putDataList(invcRegService.getCounterPartyList(paramMap));
		return respBean;
	}
