...
public class Cntrct {
    ...
    /**
     * 协调人电子邮箱
     * @param coordinatorEmail 协调人电子邮箱
     */
    ...
    /**
     * 0.按季结息 1.按月结息 2.到期利随本清 3.预收利息，到期结息
     * @param intWay 0.按季结息 1.按月结息 2.到期利随本清 3.预收利息，到期结息
     */
    ...
    /**
     * 0.转让应收账款时支付费用 1.获得融资款项时支付费用 2.从费用承担方的息费扣收账户中扣收费用
     * @param deduMethod 0.转让应收账款时支付费用 1.获得融资款项时支付费用 2.从费用承担方的息费扣收账户中扣收费用
     */
