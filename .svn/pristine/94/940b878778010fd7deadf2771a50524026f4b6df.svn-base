...
public class PaymentReqBean {
	...
	private List<PaymentDetailReqBean> invcs;

	public List<PaymentDetailReqBean> getInvcs() {
		return invcs;
	}

	public void setInvcs(List<PaymentDetailReqBean> invcs) {
		this.invcs = invcs;
	}
	...
	public String getLimitOccId() {
		return limitOccId;
	}

	public void setLimitOccId(String limitOccId) {
		this.limitOccId = limitOccId;
	}
